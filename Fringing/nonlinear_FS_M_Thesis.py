...
"""
In this section, we only simulate the influence of parameter M on the phase profile keeping other parameters constant, and how they affect the normalized intensities of the 0th order and the 1st orders.
