...
plt.figure(2)
plt.plot(gray,Mc[0][0],label=f"M={B[0]},order={m[0]}")
plt.plot(gray,Mc[0][1],label=f"M={B[0]},order={m[1]}")

plt.plot(gray,Mc[1][0],label=f"M={B[1]},order={m[0]}")
plt.plot(gray,Mc[1][1],label=f"M={B[1]},order={m[1]}")
